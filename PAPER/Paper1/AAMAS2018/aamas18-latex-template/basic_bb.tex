...
\hspace*{3ex} \hspace*{3ex} \hspace*{3ex} $BestVal = \delta^*$ {\em {\footnotesize /* update best det. policy */}}\\
\hspace*{3ex} \hspace*{3ex} {\bf else}: \hspace*{3ex} {\em {\footnotesize /* create the two child nodes */}}\\
...
%Algorithm to find an optimal deterministic policy.} 
\label{fig:basic_bb}
