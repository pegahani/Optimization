...
The algorithm used to achieve this goal is a branch-and-bound framework (see \cite{bertsimas2005optimization}, Section $11$ for an exhaustive explanation of the branch-and-bound algorithm) that uses the Benders decomposition procedure described in the previous section as bounding procedure. \ET{We use branch-and-bound approach because it is the most widely and effective algorithm in combinatorial optimisation since decades.} %Any equivalent algorithm can be used to illustrate our contribution. 
