...
\hspace*{3ex} \hspace*{3ex} {\bf if} $\delta^* < Best Val$ {\bf then}: {\em {\footnotesize /* comparing the stoc. pol. with the best det. pol. */}}\\
\hspace*{3ex} \hspace*{3ex} \hspace*{3ex} {\bf if} $f^*$  is deterministic {\bf then}:\\
\hspace*{3ex} \hspace*{3ex} \hspace*{3ex} \hspace*{3ex} $BestVal = \delta^*$ {\em {\footnotesize /* update the best det. policy */}}\\
